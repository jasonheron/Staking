...
import { Session, Descriptor, AbortableCall, AsyncResultWithTypedError, ResultWithTypedError, Success, AnyError, Logger } from '../types';
...
export declare abstract class AbstractTransport extends TypedEmitter<{
    ...
    }): AbortableCall<undefined, typeof ERRORS.DEVICE_DISCONNECTED_DURING_ACTION | typeof ERRORS.HTTP_ERROR | typeof ERRORS.WRONG_RESULT_TYPE | typeof ERRORS.OTHER_CALL_IN_PROGRESS | typeof PROTOCOL_MALFORMED | typeof ERRORS.UNEXPECTED_ERROR | typeof ERRORS.SESSION_NOT_FOUND | typeof ERRORS.ABORTED_BY_TIMEOUT | typeof ERRORS.ABORTED_BY_SIGNAL | typeof ERRORS.WRONG_ENVIRONMENT>;
    abstract receive(params: {
        path?: string;
        session: string;
        protocol?: TransportProtocol;
    }): AbortableCall<MessageFromTrezor, typeof ERRORS.HTTP_ERROR | typeof ERRORS.WRONG_RESULT_TYPE | typeof ERRORS.OTHER_CALL_IN_PROGRESS | typeof PROTOCOL_MALFORMED | typeof ERRORS.DEVICE_DISCONNECTED_DURING_ACTION | typeof ERRORS.UNEXPECTED_ERROR | typeof ERRORS.SESSION_NOT_FOUND | typeof ERRORS.ABORTED_BY_TIMEOUT | typeof ERRORS.ABORTED_BY_SIGNAL | typeof ERRORS.WRONG_ENVIRONMENT>;
    abstract call(params: {
        session: string;
        name: string;
        data: Record<string, unknown>;
        protocol?: TransportProtocol;
    }): AbortableCall<MessageFromTrezor, typeof ERRORS.HTTP_ERROR | typeof ERRORS.WRONG_RESULT_TYPE | typeof ERRORS.OTHER_CALL_IN_PROGRESS | typeof ERRORS.DEVICE_DISCONNECTED_DURING_ACTION | typeof PROTOCOL_MALFORMED | typeof ERRORS.UNEXPECTED_ERROR | typeof ERRORS.ABORTED_BY_TIMEOUT | typeof ERRORS.ABORTED_BY_SIGNAL | typeof ERRORS.WRONG_ENVIRONMENT | typeof ERRORS.DEVICE_NOT_FOUND | typeof ERRORS.INTERFACE_UNABLE_TO_OPEN_DEVICE | typeof ERRORS.INTERFACE_DATA_TRANSFER>;
    abstract stop(): void;
    private getDiff;
